...
package uk.gov.hmrc.securitiestransferchargeregistration.viewmodels.govuk
...
import uk.gov.hmrc.securitiestransferchargeregistration.viewmodels.{ErrorMessageAwareness, InputWidth}
