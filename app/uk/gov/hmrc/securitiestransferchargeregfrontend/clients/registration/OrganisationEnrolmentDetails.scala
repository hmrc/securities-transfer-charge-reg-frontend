...
final case class OrganisationEnrolmentResponseDto(enrolled: Boolean)

object OrganisationEnrolmentResponseDto {
  implicit val format: OFormat[OrganisationEnrolmentResponseDto] = Json.format[OrganisationEnrolmentResponseDto]
}
