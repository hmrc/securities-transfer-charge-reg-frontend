...
package uk.gov.hmrc.securitiestransferchargeregfrontend.viewmodels.govuk
...
import uk.gov.hmrc.securitiestransferchargeregfrontend.viewmodels.{ErrorMessageAwareness, InputWidth}
