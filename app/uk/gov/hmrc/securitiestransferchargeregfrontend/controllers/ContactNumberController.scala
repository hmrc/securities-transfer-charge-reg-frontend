...
import uk.gov.hmrc.securitiestransferchargeregfrontend.views.html.ContactNumberView
...
import uk.gov.hmrc.securitiestransferchargeregfrontend.pages.ContactNumberPage
