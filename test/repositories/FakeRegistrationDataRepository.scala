...
class FakeRegistrationDataRepository(data: RegistrationData = Fixtures.registrationData) extends RegistrationDataRepository {
  ...
  override def setSafeId(id: String)(maybeSafeId: Option[String]): Future[Unit] = Future.successful(())
  ...
  override def setStartedAt(id: String): Future[Unit] = Future.successful(())
}
