...
class UpdateDetailsKickOutViewSpec extends ViewBaseSpec {
  ...
  private val viewInstance         = app.injector.instanceOf[UpdateDetailsKickOutView]
  ...
  object ExpectedIndividual {
    val title = "You must update the details on your government gateway account"
    val heading = "You must update the details on your government gateway account"
